...
This script particularly emphasizes on the **query translation techniques**, including **multi-query generation, rag-fusion, query decomposition, step-back and HyDE**.  
The relative papers:  
